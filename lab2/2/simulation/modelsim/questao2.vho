...
-- Y	=>  Location: PIN_U22,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
ARCHITECTURE structure OF questao2_A IS
...
-- Equation(s):
-- \inst4~0_combout\ = (\B~combout\ & ((\C~combout\))) # (!\B~combout\ & (!\A~combout\))
